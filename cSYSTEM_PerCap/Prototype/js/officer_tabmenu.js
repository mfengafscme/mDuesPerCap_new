...
document.write('									<TD align="center" class="TabTD"><A href="OfficerDetailEdit.htm" title="Edit Officer Detail" class="TabFONT">Edit</A></TD>');
...
document.write('								<TR>');
document.write('									<TD class="TabImageTD"><IMG src="' + left + '" class="TabImage"></TD>');
document.write('									<TD align="center" class="TabTD"><FONT class="CurrentTabFONT">Officer Detail</FONT></TD>');
document.write('									<TD class="TabImageTD" align="right"><IMG src="' + right + '" class="TabImage"></TD>');
document.write('								</TR>');
document.write('							</TABLE>');
document.write('						</TD>');
...
//document.write('								<TR>');
//document.write('									<TD class="TabImageTD"><IMG src="' + left + '" class="TabImage"></TD>');
//document.write('									<TD align="center" class="TabTD"><A href="AddressSelection.htm" title="Maintain Address Association" class="TabFONT">Address Association</A></TD>');
//document.write('									<TD class="TabImageTD" align="right"><IMG src="' + right + '" class="TabImage"></TD>');
//document.write('								</TR>');
//document.write('							</TABLE>');
//document.write('						</TD>');
