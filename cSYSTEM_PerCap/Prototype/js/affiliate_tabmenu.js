...
if (screen == "AffiliateDetail") {
...
} else if (screen == "CharterInformation") {
	document.write('									<TD align="center" class="TabTD"><A href="CharterInformationEdit.htm" title="Edit Charter Information" class="TabFONT">Edit</A></TD>');
} else if (screen == "ConstitutionInformation") {
	document.write('									<TD align="center" class="TabTD"><A href="ConstitutionInformationEdit.htm" title="Edit Constitution Information" class="TabFONT">Edit</A></TD>');
	...
	document.write('									<TD align="center" class="TabTD"><A href="MailingListsInformationEdit_ForAffiliate.htm" title="Edit Mailing List Information" class="TabFONT">Edit</A></TD>');
}
...
document.write('								<TR>');
document.write('									<TD class="TabImageTD"><IMG src="' + left + '" class="TabImage"></TD>');
if (screen == "CharterInformation") {
	document.write('									<TD align="center" class="TabTD"><FONT class="CurrentTabFONT">Charter</FONT></TD>');
} else {
...
document.write('								<TR>');
document.write('									<TD class="TabImageTD"><IMG src="' + left + '" class="TabImage"></TD>');
if (screen == "ConstitutionInformation") {
	document.write('									<TD align="center" class="TabTD"><FONT class="CurrentTabFONT">Constitution</FONT></TD>');
} else {
...
if (screen == "OfficerTitles") {
	document.write('									<TD align="center" class="TabTD"><FONT class="CurrentTabFONT">Officer Titles</FONT></TD>');
} else {
...
document.write('								<TR>');
document.write('									<TD class="TabImageTD"><IMG src="' + left + '" class="TabImage"></TD>');
/*if (screen == "ConventionStatistical") {
	document.write('									<TD align="center" class="TabTD"><FONT class="CurrentTabFONT">Convention Statistics</FONT></TD>');
} else {
