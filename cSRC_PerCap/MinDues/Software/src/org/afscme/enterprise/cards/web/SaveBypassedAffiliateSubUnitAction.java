...
/**
 * @struts:action   path="/saveBypassedAffiliateSubUnitAction"
 *                  name="saveBypassedaffiliateSubUnit"
 *                  validate="false"
 *                  scope="request"
 *                  input="/Membership/GetBypassedAffiliate.jsp"
 */
public class SaveBypassedAffiliateSubUnitAction extends AFSCMEAction {
    
    /** Creates a new instance of SaveBypassedAffiliateSubUnitAction */
    public SaveBypassedAffiliateSubUnitAction() {
    }
