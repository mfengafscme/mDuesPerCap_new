...
/**
 * @struts:action   path="/saveBypassedAffiliateAnnualCardRunTypeAction"
 *                  name="saveBypassedAffiliateAnnualCardRunTypeAction"
 *                  validate="false"
 *                  scope="request"
 *                  input="/Membership/GetBypassedAffiliate.jsp"
 */
public class SaveBypassedAffilateAnnualCardRunTypeAction extends AFSCMEAction {
    
    /** Creates a new instance of SaveBypassedAffiliateAnnualCardRuntTypeAction */
    public SaveBypassedAffilateAnnualCardRunTypeAction() {
    }
    ...
    throws Exception {
        ...
        GetBypassedAffilatesForm gbaf = null;
