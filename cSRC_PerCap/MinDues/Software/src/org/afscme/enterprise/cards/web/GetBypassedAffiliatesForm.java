...
/**
 * @struts:form name="GetBypassedAffiliatesorm"
 */
public class GetBypassedAffiliatesForm extends org.apache.struts.action.ActionForm {
    
    private static Logger logger =  Logger.getLogger(GetBypassedAffiliatesForm.class);
    ...
    /** Creates a new instance of GetBypassedAffiliatesForm */
    public GetBypassedAffiliatesForm() {
        this.init();
    }
