...
/**
 * @struts:action   path="/saveBypassedAffiliateCNRetChapActon"
 *                  name="saveBypassedAffiliateCNRetChapAction"
 *                  validate="false"
 *                  scope="request"
 *                  input="/Membership/GetBypassedAffiliates.jsp"
 */
public class SaveBypassedAffiliateCNRetChapAction extends AFSCMEAction {
    
    /** Creates a new instance of SaveBypassedAffiliateCNRetChapAction */
    public SaveBypassedAffiliateCNRetChapAction() {
    }
    ...
    throws Exception {
        ...
        if (request.getParameter("cancel") != null) {
            request.setAttribute("getBypassedAffiliateForm", gbaf);
            cleanupSession(session);
        ...
        if (gbaf.getAffPk() != null) {
           ...
           /* gbaf = (GetBypassedAffiliateForm)session.getAttribute("newAffiliateForm");*/
