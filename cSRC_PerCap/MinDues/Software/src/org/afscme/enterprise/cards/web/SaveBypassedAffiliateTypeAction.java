...
/**
 * @struts:action   path="/saveBypassedaffiliateTypeAction"
 *                  name="saveBypassedaffiliateType"
 *                  validate="false"
 *                  scope="request"
 *                  input="/Membership/GetBypassedAffiliate.jsp"
 */
public class SaveBypassedAffiliateTypeAction extends AFSCMEAction {
    
    /** Creates a new instance of SaveBypassedAffiliateTypeAction */
    public SaveBypassedAffiliateTypeAction() {
    }
    ...
    throws Exception {
        ...
        if (request.getParameter("continue") != null || request.getParameter("cancel") != null) {
            gbaf = (GetBypassedAffiliatesForm)session.getAttribute("getBypassedAffiliatesForm");;
        ...
        if (gbaf.getAffPk() != null) {
          ...
          /*  // Retrieve cached form and set the parent fk to the value retrieve in the new form
            gbaf = (AffiliateDetailAddForm)session.getAttribute("newAffiliateForm");
