...
/**
 * @struts:action   path="/saveBypassedAffiliateLocalSubChapterAction"
 *                  name="saveBypassedAffiliateLocalSubChapter"
 *                  validate="false"
 *                  scope="request"
 *                  input="/Membership/GetBypassedAffiliates.jsp"
 */
public class SaveBypassedAffiliateLocalSubChapterAction extends AFSCMEAction {
    
    /** Creates a new instance of SaveBypassedAffiliateLocalSubChapterAction */
    public SaveBypassedAffiliateLocalSubChapterAction() {
    }
    ...
    throws Exception {
        ...
        if (request.getParameter("continue") != null || request.getParameter("cancel") != null) {
            gbaf = (GetBypassedAffiliatesForm)session.getAttribute("affiliateDetailAddForm");;
