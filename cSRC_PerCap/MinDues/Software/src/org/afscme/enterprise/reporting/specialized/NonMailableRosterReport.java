/** Class Name  : NonMailableRosterReport.java
    Date Written: 20031027
    Author      : Kyung A. Callahan
    Description : 
    Note        : 
    Maintenance : Kyung 20031112 fix problem where it is not returning all expected rows.
 */
...
import java.util.*;
// This is a non-mailable roster specialized report.
public class NonMailableRosterReport implements ReportHandler 
{
	...
	ResultSet rs = null;;
   	try 
        ...
        catch (SQLException e) 
        {
            ...
            writer.newLine();
            writer.newLine();
            writer.write("An error has occurred in program - NonMailableRosterReport.");
            writer.newLine();
    ...
    */
    private void printHeading(BufferedWriter writer) throws IOException
    {
        ...
        if (reportType.equals("L")) {
            ...
            writer.write("Non-Mailable Roster");
        }
        else {
            writeColumnSpace(writer, 28);
            writer.write("Non-Mailable Roster for Retiree");
        }
        writer.newLine();
    ...
    */
        ...
        throws IOException, SQLException
    {
        sqlQuery = 
            ...
            "(select common_codes.com_cd_sort_key " +
            "from common_codes " + 
            "where common_codes.com_cd_cd = aff_organizations.aff_statenat_type " + 
            "and common_codes.com_cd_type_key = 'affiliatestate') " + 
            "as sort_state, " +
            "case " +
            ...
            "and common_codes.com_cd_pk = 31001 /* active member */ " +
            ...
            "and person_address.addr_bad_fg = 1 /* member's bad address */ " +
    ...
    */
        ...
        throws IOException, SQLException
    {
        ...
        if (membersFullName == null) membersFullName = " ";
        if (membersFullName.length() > 25)
        {
            membersFullName = membersFullName.substring(0, 24);
        }
    ...
    */
        ...
        throws IOException, SQLException, Exception
    {
        ...
        {
            writer.newLine();
            writer.write("Total Member with non-mailable address: ");
        ...
        throws IOException, SQLException, Exception
    {
        ...
        writer.newLine();                   
        writer.newLine();                   
        writer.write("Final Total Member with non-mailable address: ");
    ...
    */
        ...
        throws IOException, SQLException, Exception
    {
        ...
        writeValue(writer, membersFullName, 25);
        //writer.newLine();
        writeColumnSpace(writer, 9);
