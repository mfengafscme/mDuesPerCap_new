/** Class Name  : MembershipRosterAction.java
...
import org.afscme.enterprise.reporting.specialized.MembershipRosterReport;
...
/**
 * @struts:action   path="/membershipRosterReport"
 *                  name="membershipRosterForm"
 *                  scope="request"
 *                  validate="true"
 *                  input="/Reporting/Specialized/MembershipRoster.jsp"
 */
public class MembershipRosterAction extends AFSCMEAction {

	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, UserSecurityData usd) throws Exception {

        MembershipRosterForm nuForm = (MembershipRosterForm)form;

        //submit the report for generation

        MembershipRosterReport report = new MembershipRosterReport();
        report.setReportType(nuForm.getReportType());
        s_baseReport.generateReport(usd.getUserId(), new Integer(17), new MediaType(MediaType.PRINT), report); 
