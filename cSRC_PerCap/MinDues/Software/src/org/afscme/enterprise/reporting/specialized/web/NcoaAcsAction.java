/** Class Name  : NcoaAcsAction.java
    Date Written: 20031030
    Author      : Kyung A. Callahan
    Description :
    Maintenance : Kyung 20031031 debug why the report is not comming out.
*/
...
import org.afscme.enterprise.reporting.specialized.NcoaAcsReport;
...
/**
 * @struts:action   path="/ncoaAcsReport"
 *                  name="ncoaAcsForm"
 *                  scope="request"
 *                  validate="true"
 *                  input="/Reporting/Specialized/NcoaAcs.jsp"
 */
public class NcoaAcsAction extends AFSCMEAction {

	public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, UserSecurityData usd) throws Exception {

        NcoaAcsForm nuForm = (NcoaAcsForm)form;

        //submit the report for generation

        NcoaAcsReport report = new NcoaAcsReport();
        report.setReportType(nuForm.getReportType());
        s_baseReport.generateReport(usd.getUserId(), new Integer(20), new MediaType(MediaType.PRINT), report); 
