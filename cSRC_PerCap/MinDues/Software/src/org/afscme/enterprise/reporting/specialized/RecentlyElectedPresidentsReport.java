/** Class Name  : RecentlyElectedPresidentsReport.java
    Date Written: 20031021
    Author      : Kyung A. Callahan
    Description : This is a recently elected president report program.
    Note        : 
...
public class RecentlyElectedPresidentsReport implements ReportHandler 
{
    /**
    * Define variables
    */
    ...
    */
    private void headingRoutine(BufferedWriter writer) throws IOException
    {
        ...
        writer.write("Recently Elected Presidents as of ");
    ...
    */
        ...
        throws IOException, SQLException
    {
        sqlQuery = 
            ...
            "and officer_history.afscme_office_pk = 9 /* officer who hods the president's position */ " +
...
} // end of officerStatisticalSummaryReport