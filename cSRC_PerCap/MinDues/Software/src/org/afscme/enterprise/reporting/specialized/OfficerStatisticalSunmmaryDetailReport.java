/** Class Name  : OfficerStatisticalSunmmaryDetailReport.java
    Date Written: 20031030
    Author      : Kyung A. Callahan
    Description : This is a officer statistical summary detail report program.
    Note        : 
...
// This is a officer statistical summary detail specialized report.
public class OfficerStatisticalSunmmaryDetailReport implements ReportHandler 
{
    ...
    /**
    * Generates a officer statistical summary detail report.
    */
	...
	ResultSet rs = null;
  	...
  	try 
        ...
        catch (SQLException e) 
        {
            ...
            writer.newLine();
            writer.newLine();
            writer.write("An error has occurred in program - OfficerStatisticalSunmmaryDetailReport.java");
            writer.newLine();
    ...
    */
    private void printHeading(BufferedWriter writer) throws IOException
    {
        ...
        writer.newLine();
        writeColumnSpace(writer, 46);
        if (reportType.equals("L"))
            writer.write("Regular Officer Statistical Summary Detail");
        else
            writer.write("Retiree Officer Statistical Summary Detail");
        writer.newLine();
