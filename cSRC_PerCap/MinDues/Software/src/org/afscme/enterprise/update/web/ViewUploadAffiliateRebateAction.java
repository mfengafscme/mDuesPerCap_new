...
/**
 * @struts:action   path="/viewUploadAffiliateRebate"
 *                  scope="request"
 *
 * @struts:action-forward   name="View"  path="/Update/UploadAffiliateRebateData.jsp"
 */
public class ViewUploadAffiliateRebateAction extends AFSCMEAction {
