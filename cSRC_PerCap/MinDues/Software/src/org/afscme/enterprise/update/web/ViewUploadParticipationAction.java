...
/**
 * @struts:action   path="/viewUploadParticipation"
 *                  scope="request"
 *
 * @struts:action-forward   name="View"  path="/Update/UploadParticipationData.jsp"
 */
public class ViewUploadParticipationAction extends AFSCMEAction {
