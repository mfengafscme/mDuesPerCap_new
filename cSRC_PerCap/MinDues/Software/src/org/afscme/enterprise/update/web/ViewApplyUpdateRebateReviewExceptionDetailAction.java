/*
 * ViewApplyUpdateRebateExceptionDetail.java
 *
 * Created on August 8, 2003, 11:08 AM
 */
/***********************************************************************************/
/* Called by:               ApplyUpdateRebateReviewSummary.jsp
 *
 * Forwards request to:     ApplyUpdateRebateExceptionDetail.jsp
 *
 ...
 *                          ApplyUpdateRebateExceptionDetail.jsp. 
 *
 * Required:                None
 *
 *
...
/******************************************************************************/
/**
 * @struts:action           path="/viewApplyUpdateRebateReviewExceptionDetail"
 *                  
 *                          scope="request"
 *                  
 *
 * @struts:action-forward   name="success"  path="/Update/ApplyUpdateRebateExceptionDetail.jsp"
 */

public class ViewApplyUpdateRebateReviewExceptionDetailAction extends AFSCMEAction {
    ...
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, UserSecurityData usd) throws Exception {
        ...
        Logger log = Logger.getLogger(ViewApplyUpdateRebateReviewExceptionDetailAction.class);
        log.debug("----------------------------------------------------");
