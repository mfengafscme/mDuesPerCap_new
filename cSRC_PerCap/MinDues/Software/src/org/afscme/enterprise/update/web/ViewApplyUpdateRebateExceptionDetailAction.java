 ...
 */
/***********************************************************************************/
/* Called by:               ApplyUpdateRebateEditSummary.jsp
 *
 ...
 *                          on the screen using ApplyUpdateRebateExceptionDetail.jsp. 
 *
 * Required:                None
 *
 *
...
/******************************************************************************/
/**
 * @struts:action   path="/viewApplyUpdateRebateExceptionDetail"
 *                  
 *                  scope="request"
 *                  
 *
...
public class ViewApplyUpdateRebateExceptionDetailAction extends AFSCMEAction {
    ...
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, UserSecurityData usd) throws Exception {
        ...
        Logger log = Logger.getLogger(ViewApplyUpdateRebateExceptionDetailAction.class);
        log.debug("----------------------------------------------------");
