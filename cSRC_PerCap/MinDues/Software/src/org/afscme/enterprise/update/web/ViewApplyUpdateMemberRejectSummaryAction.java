 ...
 *
 * Forwards request to:     ApplyUpdateMemberRejectSummary.jsp
 *
 * Purpose:                 This action transfers the request to ApplyUpdateMemberRejectSummary.jsp
 *                          
 * Required:                None
 *
 *
...
/******************************************************************************/
/**
 * @struts:action   path="/viewApplyUpdateMemberRejectSummary"
 *
 *                  scope="request"
 *                  input="/Update/ApplyUpdateMemberEditSummary.jsp"
 *
 * @struts:action-forward   name="success"  path="/Update/ApplyUpdateMemberRejectSummary.jsp"
 */

public class ViewApplyUpdateMemberRejectSummaryAction extends AFSCMEAction{
