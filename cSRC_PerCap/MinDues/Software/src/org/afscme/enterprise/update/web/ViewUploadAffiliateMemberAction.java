...
/**
 * @struts:action   path="/viewUploadAffiliateMember"
 *                  scope="request"
 *
 * @struts:action-forward   name="View"  path="/Update/UploadAffiliateMemberData.jsp"
 */
public class ViewUploadAffiliateMemberAction extends AFSCMEAction {
