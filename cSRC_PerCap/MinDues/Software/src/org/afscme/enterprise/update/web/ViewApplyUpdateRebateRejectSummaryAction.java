 ...
 *
 * Forwards request to:     ApplyUpdateRebateRejectSummary.jsp
 *
 * Purpose:                 This action transfers the request to ApplyUpdateRebateRejectSummary.jsp
 *                          
 * Required:                None
 *
 *
...
/******************************************************************************/
/**
 * @struts:action   path="/viewApplyUpdateRebateRejectSummary"
 *
 *                  scope="request"
 *                  input="/Update/ApplyUpdateRebateEditSummary.jsp"
 *
 * @struts:action-forward   name="success"  path="/Update/ApplyUpdateRebateRejectSummary.jsp"
 */

public class ViewApplyUpdateRebateRejectSummaryAction extends AFSCMEAction{
...
}//end of ViewApplyUpdateRebateRejectSummaryAction
