...
/**
 * @struts:form name="ApplyUpdateRebateRejectForm"
 */
public class ApplyUpdateRebateRejectForm extends ActionForm{
    ...
    private static Logger logger = Logger.getLogger(ApplyUpdateRebateRejectForm.class);
