 ...
 *                          on the screen using ApplyUpdateOfficerExceptionDetail.jsp. 
 *
 * Required:                None
 *
 *
...
/******************************************************************************/
/**
 * @struts:action   path="/viewApplyUpdateOfficerExceptionDetail"
 *                  
 *                  scope="request"
 *                  
 *
...
public class ViewApplyUpdateOfficerExceptionDetailAction extends AFSCMEAction {
    ...
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, UserSecurityData usd) throws Exception {
        ...
        Logger log = Logger.getLogger(ViewApplyUpdateOfficerExceptionDetailAction.class);
        log.debug("----------------------------------------------------");
