...
/**
 * @struts:form name="ApplyUpdateMemberRejectForm"
 */
public class ApplyUpdateMemberRejectForm extends ActionForm{
    ...
    private static Logger logger = Logger.getLogger(ApplyUpdateMemberRejectForm.class);
