...
/**
 * Searches for organizations, based on criteria in the SearchPersonForm.
 * Params:
 *      new - if present, the user is shown the search form.
 *
 * @struts:action   path="/searchPerson"
 *                  input="/Membership/BasicPersonSearch.jsp"
 *                  name="searchPersonForm"
 *                  validate="true"
 *                  scope="session"
 *
 * @struts:action-forward name="SearchForm" path="/Membership/BasicPersonSearch.jsp"
 ...
 */
public class SearchPersonAction extends AFSCMEAction {
    ...
    public ActionForward perform(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, 
        ...
        log.debug(" SearchPersonForm search form contents are: " + personForm.toString());
        
        //perform the search
        int count = s_maintainPersons.searchPersons(data, dept, result );
         
        log.debug("SearchPersonAction: after searchPersons call count is: " + count);
        ...
        switch (count) {
            case 0:
                ...
                request.setAttribute("searchPersonForm", personForm);
