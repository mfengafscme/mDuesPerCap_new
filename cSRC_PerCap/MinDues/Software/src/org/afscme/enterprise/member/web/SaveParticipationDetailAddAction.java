...
/* This action will save an added participation record.
 * 
 */
 
/**
 * @struts:action   path="/saveParticipationDetailAdd"
 *                  name="participationDetailForm"
 *                  input="/Membership/ParticipationDetailAdd.jsp"
 *                  scope="request"
 *                  validate="false"
 *
...
public class SaveParticipationDetailAddAction extends org.afscme.enterprise.controller.web.AFSCMEAction{
    
    /** Creates a new instance of SaveParticipationDetailAddAction */
    public SaveParticipationDetailAddAction() {
    }
    ...
    throws Exception {
        ...
        s_maintainMembers.addParticipationData(pd);
