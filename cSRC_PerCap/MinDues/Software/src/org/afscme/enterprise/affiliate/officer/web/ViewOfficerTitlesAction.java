 ...
 *
 * @struts:action   path="/viewOfficerTitles"
 *		    name="officerTitlesForm"
 *		    validate="false"
 *                  scope="request"
 *
 * @struts:action-forward   name="View"  path="/Membership/OfficerTitles.jsp"
 */  
public class ViewOfficerTitlesAction extends AFSCMEAction {
