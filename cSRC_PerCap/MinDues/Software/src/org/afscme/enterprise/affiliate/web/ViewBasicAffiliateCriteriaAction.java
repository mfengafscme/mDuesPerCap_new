...
/**
 * @struts:action   path="/viewBasicAffiliateCriteria"
 *                  name="affiliateSearchForm"
 *                  validate="false"
 *                  scope="session"
 *
 * @struts:action-forward   name="viewSearch"  path="/Membership/MinimumDuesBasicAffiliateSearch.jsp"
 */
public class ViewBasicAffiliateCriteriaAction extends AFSCMEAction {

    /** Creates a new instance of ViewBasicAffiliateCriteriaAction */
    public ViewBasicAffiliateCriteriaAction() {
    }
