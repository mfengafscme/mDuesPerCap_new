...
/**
 * @struts:action   path="/searchAffiliate"
 *                  name="affiliateSearchForm"
 *                  validate="true"
 *                  scope="session"
 *                  input="/Membership/MinimumDuesAffiliateSearchResults.jsp"
 *
 *
 * @struts:action-forward   name="search" path="/Membership/MinimumDuesAffiliateSearchResults.jsp"
 */
public class SearchAffiliateAction extends AFSCMEAction {

    /** Creates a new instance of SearchAffiliateAction */
    public SearchAffiliateAction() {
    }
    ...
    throws Exception {
        ...
        asf.setSearchAction("/searchAffiliate.action");
