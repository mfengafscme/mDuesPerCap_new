...
<%! String title = "Apply Update Officer Exception Detail", help = "ApplyUpdateOfficerExceptionDetail.html";%>
...
<TABLE cellpadding="0" cellspacing="0" border="1" class="BodyContent" align="center">
    ...
    <logic:iterate id="eComp1" name="fieldChanges"  >
        <logic:iterate id="ec" name="eComp1" property="value">
            <logic:equal name="ec" property="recordId" value="<%=(Integer.toString(((Integer)recId).intValue()))%>">
                <TR>
