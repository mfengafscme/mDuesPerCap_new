...
<html:form action="viewApplyMemberRejectSummary.action" method="post">
<!--**************************************************************************//-->
...
<TABLE cellpadding="0" cellspacing="0" border="1" class="BodyContent" width="93%" align="center">
    ...
    <TR>
        <TD align="center" class="ContentHeaderTD">
            <%String sAffPk     =   affPk   + "";
              String sQueuePk   =   queuePk + "";
            %>
            <html:hidden property="affPk"   value="<%=sAffPk%>" />
            <html:textarea  property="comments" cols="115" rows="3" ></html:textarea> 
            <html:hidden property="queuePk" value="<%=sQueuePk%>" />
