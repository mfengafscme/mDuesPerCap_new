...
<%! String title = "Upload Affiliate Member Data", help = "UploadAffiliateMemberData.html";%>
<%@ include file="../include/header.inc" %> 


<html:form action="/uploadAffiliateMember" enctype="multipart/form-data" method="post" styleId="form" focus="affType">
