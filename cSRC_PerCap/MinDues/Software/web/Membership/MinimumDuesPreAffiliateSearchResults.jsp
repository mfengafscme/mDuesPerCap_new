<%! String title = "Search Results", help = "AffiliateSearchResults.html";%>
...
<TABLE cellpadding="0" cellspacing="0" border="0" class="ContentTable" align="center">
    <TR valign="top">
    	...
    	<TD align="right">
		<BR>
		<afscme:button action="/viewPreAffiliateCriteria.action">New Search</afscme:button>
		<BR> 
    	</TD>
    </TR>
</TABLE>
...
</logic:notPresent> <logic:present name="affiliateSearchForm" property="results"> 
<TABLE cellpadding="0" cellspacing="0" border="0" class="ContentTable" align="center">
  <TR valign="top"> 
...
<table cellpadding="0" cellspacing="0" border="1" class="BodyContent" align="center">
  <tr> 
    ...
    <th width="35%"> <afscme:sortLink styleClass="TH" action="<%=action%>" formName="affiliateSearchForm" field="<%=org.afscme.enterprise.affiliate.AffiliateCriteria.SORT_BY_ABBR_NAME%>">Employer 
      Name</afscme:sortLink> </th>
  ...
  <bean:define id="batch_ID" name="result" property="batch_ID" /> 
  <tr> 
    <td align="center"> <html:link page="/editPreAffiliateDetail.action" paramId="batch_ID" paramName="batch_ID" styleClass="action">Select</html:link> 
    </td>
    <td align="center"> <bean:write name="result" property="affAbreviatedNm"/> 
    </td>
    <afscme:affiliateIdWrite  name="result" property="affiliateId" /> 
    <!-- <td align="center"> <bean:write name="result" property="active"/> </td> -->
  </tr>
  </logic:iterate> 
</table>
<TABLE cellpadding="0" cellspacing="0" border="0" class="ContentTable" align="center">
