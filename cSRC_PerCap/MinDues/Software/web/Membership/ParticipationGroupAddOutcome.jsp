...
<%! String title = "Participation Group Add Outcome", help = "ParticipationGroupAddOutcome.html";%>
...
<html:form action="saveParticipationGroupOutcome" focus="name">
...
<table cellpadding="0" cellspacing="0" border="1" class="BodyContent" align="center">
    <tr valign="top">
        <td class="ContentHeaderTR">
            ...
            Type - <%=form.getTypeNm()%><BR>
            Detail - <%=form.getDetailNm()%><BR>
        </td>
    </tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="1" class="BodyContent" align="center">
    <tr valign="top">
        <td>
            <table cellpadding="1" cellspacing="1" border="0" class="InnerContentTable" width="100%">
                <tr>
