...
<%! String title = "Participation Detail Edit", help = "ParticipationDetailEdit.html";%>
...
<html:form action="/saveParticipationDetail.action" focus="detailShortcut">
...
<table width="100%" cellpadding="0" cellspacing="0" border="1" class="BodyContentNoWidth" align="center">
	...
	<TD colspan="2">
		...
		<TR>
		    <TH width="10%">
			Shortcut
			<html:hidden property="oldDetailPk" name="participationDetailForm" />			
		    </TH>
		    <TH width="30%">
			* Group
		    </TH>
		...
		<TR>
		    <TD class="ContentTD" align="center">
                        <html:text property="detailShortcut" name="participationDetailForm" size="5" maxlength="6" onblur="shortcutExecuteEdit(this.form);"/>
...
<TABLE cellpadding="0" cellspacing="0" border="0" class="ContentTable" align="center">
    <TR valign="top">
        ...
        <TD align="right">
	    <BR> 
	    <html:button property="placeholder" styleClass="button" onclick="resetParticipation(this.form)" value="Reset" />
	    <afscme:button action="/viewParticipationDetail.action" paramName="participationDetailForm" paramProperty="oldDetailPk" paramId="participDetailPk">Cancel</afscme:button>
        </TD>
    </TR>
</TABLE>
