...
<html:form action="searchAffiliate.action">
            ...
            <TD class="ContentHeaderTR">
				...
				<html:option value="C">C</html:option>
                    ...
                    <TR> 
                         ...
                         <TD class="smallFont">  
                             <html:radio name="affiliateSearchForm" property="includeSubUnits" value="false"/>Yes  
                             <html:radio name="affiliateSearchForm" property="includeSubUnits" value="true"/>No  
                         </TD> 
                         <TD colspan="2" class="ContentHeaderTD">Include Inactive</TD>  
                         <TD class="smallFont">  
                             <html:radio name="affiliateSearchForm" property="includeInactive" value="true"/>Yes  
                             <html:radio name="affiliateSearchForm" property="includeInactive" value="false"/>No  
                         </TD> 
                    </TR>
                </TABLE>
            </TD>
