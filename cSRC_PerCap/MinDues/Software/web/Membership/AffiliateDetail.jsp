<%! String title = "Affiliate Detail", help = "AffiliateDetail.html";%>
...
<bean:define name="affiliateDetail" id="affiliateDetail" type="org.afscme.enterprise.affiliate.web.AffiliateDetailForm"/>
<bean:define name="affiliateDetail" id="affPk" property="affPk"/>

<!-- Something for tabs. -->
<bean:define id="screen" value="AffiliateDetail"/>
