...
<%! String title = "Verify Person", help = "VerifyPerson.html";%>
<%@ page import="org.afscme.enterprise.person.web.SearchPersonForm" %>
<%@ include file="../include/header.inc" %>

<SCRIPT language="JavaScript" src="../js/date.js"></SCRIPT>

<html:form action="viewVerifyPerson" focus="firstNm">
    <html:hidden property="ssn"/>
    <html:hidden property="back" value='<%=(String)request.getParameter("back")%>'/>
        ...
        <tr valign="top">
            <td colspan="2" class="ContentHeaderTR">
                ...
                <table width="100%" cellpadding="1" cellspacing="1" border="0" class="InnerContentTable">
                    ...
                    <TR>
						<% if (request.getAttribute("searchPersonForm") != null) {
							SearchPersonForm form = (SearchPersonForm)request.getAttribute("searchPersonForm");
							out.print("<TD align=\"center\"><input type=\"text\" name=\"firstNm\" size=\"25\" maxlength=\"25\" value=\"" + form.getFirstNm() + "\"/>" + "</TD>");			
						}else{%>
						...
						<% if (request.getAttribute("searchPersonForm") != null) {
							SearchPersonForm form = (SearchPersonForm)request.getAttribute("searchPersonForm");
							out.print("<TD align=\"center\"><input type=\"text\" name=\"lastNm\" size=\"25\" maxlength=\"25\" value=\"" + form.getLastNm() + "\"/>" + "</TD>");			
						}else{%>
                ...
                <TABLE width="100%" cellpadding="1" cellspacing="1" border="0" class="InnerContentTable">
                    <TR>
                        ...
                        <TD width="65%"><html:text property="dob" size="10" maxlength="10"/>
                                <A href="javascript:show_calendar('verifyPersonForm.dob');" onMouseOver="window.status='Date Picker';return true;" onMouseOut="window.status='';return true;">
